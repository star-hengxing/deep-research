...
<!-- PDF-READY MARKDOWN RULES (CRITICAL - follow these to avoid broken PDF output): -->
<!-- 1. NO --- horizontal rules. Remove all of them. Headings handle visual separation. -->
<!-- 2. NO emoji in tables. Use text: 支持/不支持/部分 (or Yes/No/Partial for English). -->
<!-- 3. MAX 4 COLUMNS per table. Split wider tables into two with shared first column. -->
<!-- 4. NO ASCII art or code blocks for diagrams. Use bold text + bullet lists instead. -->
<!-- 5. BIBLIOGRAPHY: Use ordered list (1. 2. 3.) with blank line between entries. -->
<!--    Wrap URLs in angle brackets: <https://example.com> -->
<!-- 6. TABLE CELLS: Use comma to combine status + detail: "支持, API Management层" -->
